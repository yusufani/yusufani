...
public class Main {
	...
	e.printStackTrace();
		...
		RegularVehicle regular2 = new RegularVehicle("5666");
		AutoPark.getInstance().vehicleEnters("123",new Time (1,1,new Date(1,1,2019)),false);
		try {
			AutoPark.getInstance().vehicleExits("123",new Time(1,1,new Date(1,1,2018)));
		} catch (NullPointerException e) {
			System.out.println("Hattaatatatatatatattatatatata");
