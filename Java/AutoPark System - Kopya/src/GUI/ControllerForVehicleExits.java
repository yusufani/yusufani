...
public class ControllerForVehicleExits {
    ...
    void exit() {
        ...
        try{if (AutoPark.getInstance().vehicleExits(enterPlate.getText(), new Time(enterTimePicker.getValue().getHour(), enterTimePicker.getValue().getMinute()))) {
            ...
            String plate = enterPlate.getText();
